...
public class Game {
    ...
    public static void SaveStatistic(Player winner){
        if(winner != null && SharedPref != null && Players != null && Players.size() == 2) {
            SharedPreferences.Editor ed = SharedPref.edit();
            int playerScore = SharedPref.getInt(Players.get(winner.toString()), 0);
            ed.putInt(Players.get(winner.toString()), playerScore + 1);
            ed.commit();
        }
    }
